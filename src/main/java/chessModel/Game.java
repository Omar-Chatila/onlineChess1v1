	...
	public static void map(String[][] board) {
		...
		for (int i = 0; i < 8; i++) {
			for (int j = 0; j < 8; j++) {
				white = !white;
				switch (board[i][j]) {
					case "p": chessBoard[i][j] = "♟"; break;
					case "k": chessBoard[i][j] = "♚"; break;
					case "b": chessBoard[i][j] = "♝"; break;
					case "q": chessBoard[i][j] = "♛"; break;
					case "r": chessBoard[i][j] = "♜"; break;
					case "n": chessBoard[i][j] = "♞"; break;
